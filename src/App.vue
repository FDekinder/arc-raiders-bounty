...
<template>
  <div>
    ...
    <!-- Navigation -->
    <nav
      class="bg-arc-dark text-white border-b-2 border-gradient-to-r from-arc-cyan via-arc-yellow to-arc-red sticky top-0 z-50"
      ...
      <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-16">
          ...
          <button
            ...
            class="lg:hidden p-2 hover:bg-arc-navy rounded transition"
        ...
        >
          <div class="flex flex-col space-y-2 pt-4">
            <RouterLink
              to="/"
              class="px-4 py-3 hover:bg-arc-navy rounded transition"
            ...
            <div v-if="currentUser" class="border-t border-arc-red/20 pt-4 mt-4">
              <RouterLink
                ...
                class="px-4 py-3 hover:bg-arc-navy rounded transition flex items-center gap-2"
                @click="closeMobileMenu"
              >
                <RoleBadge v-if="currentUser.game_role" :role="currentUser.game_role" size="sm" />
                <span v-if="currentUser.clan_tag" class="text-arc-red font-bold">[{{ currentUser.clan_tag }}]</span>
              ...
              <button
                ...
                class="w-full px-4 py-3 hover:bg-arc-navy rounded transition flex items-center gap-2 text-gray-400"
              >
                <LogOut :size="18" />
                <span>Logout</span>
              </button>
