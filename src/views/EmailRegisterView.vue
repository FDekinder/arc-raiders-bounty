...
.submit-btn {
  @apply w-full bg-arc-red hover:bg-arc-red/80 text-black font-bold py-3 rounded-lg transition-all;
}
...
.back-btn-secondary {
  @apply flex-1 bg-arc-brown hover:bg-arc-brown/80 text-black font-bold py-3 rounded-lg transition-all;
}

.create-btn {
  @apply flex-1 bg-arc-red hover:bg-arc-red/80 text-black font-bold py-3 rounded-lg transition-all disabled:bg-arc-brown/40 disabled:cursor-not-allowed disabled:text-gray-600;
}
</style>
