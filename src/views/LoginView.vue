...
.steam-btn {
  @apply w-full bg-arc-red hover:bg-arc-red/80 text-black font-bold py-4 px-6 rounded-lg transition duration-200 flex items-center justify-center gap-3 shadow-lg shadow-arc-red/30;
}
